...
class DuelingDoubleDQNagent():
    def __init__(self):
        ...
        self.epsilon_decay = 2000000 #1000000
        ...
        self.beta = 0.4 # 0.4
        self.beta_max = 1.0
        self.beta_decay = 5000000 #5000000
        ...
        if self.load_model:
            self.model.load_weights("./DQN_tetris_model_0212.h5")
...
class DQN():
    ...
    def run(self):
        ...
        for e in range(EPISODES):
            ...
            print("episode:", e, "score:", score, "global_step:", self.global_step, "epsilon:", self.agent.epsilon, "beta:", self.agent.beta)
